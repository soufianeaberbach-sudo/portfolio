...
export const chapters: Chapter[] = [
  {
    ...
    cover: {
      image: {
        ...
        width: 1280,
        height: 720,
        alt: 'Woman in a flowing ivory dress crossing a warm architectural interior.',
        front: 1,
      },
  ...
  },
  {
    ...
    cover: {
      image: {
        ...
        width: 1280,
        height: 720,
        alt: 'Man in a black tailored suit standing in a warm architectural interior.',
        front: 1,
      },
      credit: { source: 'User-supplied chapter cover' },
      focalPosition: '58% 50%',
  ...
  },
  {
    ...
    cover: {
      image: {
        ...
        width: 1200,
        height: 850,
        alt: 'Technical specification sheet for a vegan leather jacket, with front and back flats, measurements, materials and trims.',
        front: 1,
      },
      credit: { source: 'User-supplied chapter cover' },
      focalPosition: '50% 50%',
  ...
  },
  {
    ...
    cover: {
      image: {
        ...
        width: 1280,
        height: 720,
        alt: 'Two chrome mannequin figures wearing developed garments in a dark studio.',
        front: 1,
      },
      credit: { source: 'User-supplied chapter cover' },
      focalPosition: '59% 50%',
